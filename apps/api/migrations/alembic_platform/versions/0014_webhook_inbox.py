...
revision = "platform_0014_webhook_inbox"
down_revision = "platform_0013_integrations"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.execute(
        "alter table service_webhook_receivers add foreign key(created_by) references platform_users(id) on delete set null"
    )
