...
class BuildManagerService:
    ...
    async def list_profiles(self, tenant: str | None = None) -> list[dict]:
    ...
    async def create_build_request(self, payload: BuildRequestInput) -> dict:
    ...
    async def list_jobs(self, tenant: str | None = None, limit: int = 50) -> list[dict]:
