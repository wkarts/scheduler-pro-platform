...
api_router.include_router(
    landing_pages.router, prefix="/landing-pages", tags=["Landing Pages"],
...
api_router.include_router(
    whatsapp.router, prefix="/integrations/whatsapp", tags=["WhatsApp"],
...
# /branding/manifest is intentionally public; mutating branding endpoints enforce RBAC in the route module.
api_router.include_router(branding.router, prefix="/branding", tags=["Branding"])
api_router.include_router(
    platform.router, prefix="/platform", tags=["Platform"],
    dependencies=[Depends(require_super_admin)],
)
api_router.include_router(
    builds.router, prefix="/platform/builds", tags=["Build Manager"],
    dependencies=[Depends(require_super_admin)],
)
