...
<template>
  <main class="tenant-login-page">
    <section class="tenant-login-visual">
      <div class="tenant-login-brand">
        <img v-if="manifest?.assets.logo_url" :src="manifest.assets.logo_url" :alt="manifest.app.public_name" />
...
<style>
.tenant-login-page{min-height:100vh;display:grid;grid-template-columns:minmax(0,1.15fr) minmax(390px,.85fr);background:#f8fafc;color:#0f172a}.tenant-login-visual{position:relative;overflow:hidden;display:flex;flex-direction:column;padding:clamp(34px,6vw,82px);background:radial-gradient(circle at 12% 18%,rgba(37,99,235,.33),transparent 34%),radial-gradient(circle at 86% 76%,rgba(124,58,237,.3),transparent 36%),linear-gradient(145deg,#071426,#0d1b2a 46%,#172554);color:#fff}.tenant-login-visual:after{content:"";position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(to bottom,rgba(0,0,0,.7),transparent)}.tenant-login-brand,.tenant-login-copy,.tenant-login-foot{position:relative;z-index:1}.tenant-login-brand{display:flex;align-items:center;gap:15px}.tenant-login-brand img{width:auto;max-width:190px;max-height:58px;object-fit:contain}.tenant-login-mark{width:54px;height:54px;border-radius:17px;display:grid;place-items:center;background:linear-gradient(135deg,#2563eb,#7c3aed);box-shadow:0 15px 38px rgba(37,99,235,.35)}.tenant-login-brand strong,.tenant-login-brand span{display:block}.tenant-login-brand strong{font-size:18px}.tenant-login-brand span{margin-top:3px;color:#a5b4fc;font-size:12px}.tenant-login-copy{margin:auto 0;max-width:760px}.tenant-login-kicker{display:inline-flex;padding:7px 11px;border:1px solid rgba(255,255,255,.16);border-radius:999px;background:rgba(255,255,255,.06);font-size:11px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.tenant-login-copy h1{max-width:720px;margin:22px 0 15px;font-size:clamp(38px,5.3vw,72px);line-height:.98;letter-spacing:-.055em}.tenant-login-copy p{max-width:620px;margin:0;color:#cbd5e1;font-size:clamp(15px,1.6vw,19px);line-height:1.7}.tenant-login-foot{color:#64748b;font-size:11px}.tenant-login-card{align-self:center;width:min(470px,calc(100% - 48px));margin:auto;padding:38px;border:1px solid #e2e8f0;border-radius:25px;background:#fff;box-shadow:0 24px 70px rgba(15,23,42,.09)}.tenant-login-card-head span{font-size:11px;font-weight:900;color:#2563eb;text-transform:uppercase;letter-spacing:.08em}.tenant-login-card-head h2{margin:8px 0 7px;font-size:30px;letter-spacing:-.035em}.tenant-login-card-head p{margin:0 0 27px;color:#64748b;line-height:1.5}.tenant-login-card label{display:grid;gap:7px;margin:15px 0;font-size:12px;font-weight:800;color:#334155}.tenant-login-card input{height:48px;border:1px solid #cbd5e1;border-radius:12px;padding:0 14px;font:inherit;outline:none}.tenant-login-card input:focus{border-color:#2563eb;box-shadow:0 0 0 3px rgba(37,99,235,.11)}.tenant-login-button{width:100%;height:50px;margin-top:12px;border:0;border-radius:13px;display:flex;align-items:center;justify-content:center;gap:8px;background:linear-gradient(135deg,#2563eb,#7c3aed);color:#fff;font:inherit;font-weight:900;cursor:pointer}.tenant-login-button:disabled{opacity:.65;cursor:wait}.tenant-login-error{padding:10px 12px;border-radius:10px;background:#fef2f2;color:#b91c1c;font-size:12px}@media(max-width:840px){.tenant-login-page{display:block;background:#0d1b2a;padding:16px}.tenant-login-visual{min-height:300px;border-radius:24px;padding:28px}.tenant-login-copy{margin:64px 0 30px}.tenant-login-copy h1{font-size:38px}.tenant-login-foot{display:none}.tenant-login-card{position:relative;width:calc(100% - 24px);margin:-34px auto 20px;padding:28px;border-radius:21px;z-index:3}}@media(max-width:520px){.tenant-login-page{padding:0}.tenant-login-visual{border-radius:0;min-height:330px;padding:24px 20px 64px}.tenant-login-brand img{max-width:150px;max-height:48px}.tenant-login-copy{margin:54px 0 12px}.tenant-login-copy h1{font-size:34px}.tenant-login-card{width:calc(100% - 24px);margin:-42px 12px 20px;padding:24px}}
</style>
