...
export function installPublicAnalytics(input:Record<string,unknown>|undefined):AnalyticsConfig{
  ...
  if(c.meta_pixel_id&&!window.fbq){const fbq:any=function(...args:unknown[]){fbq.queue.push(args)};fbq.queue=[];fbq.loaded=true;fbq.version='2.0';window.fbq=fbq;script('sp-meta-pixel','https://connect.facebook.net/en_US/fbevents.js');fbq('init',c.meta_pixel_id)}
